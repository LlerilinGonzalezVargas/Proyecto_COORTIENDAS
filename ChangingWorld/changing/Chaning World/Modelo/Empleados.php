...
Obser_emp
  ...
  public function Agregar_Empleado(){
    ...
    $sql="insert into empleados (ID_empl,Est_usu,Sol_empl, Email_empl  ,Pass_emp  ,Obser_empl  ) 
  values ('$this->Id_emp','$this->EstadoUsu_Id_est_usu','$this->Solicitud_empleado_idSolicitud','$this->Email_emp','$this->Pass_emp', '$his->Obser_emp');";
