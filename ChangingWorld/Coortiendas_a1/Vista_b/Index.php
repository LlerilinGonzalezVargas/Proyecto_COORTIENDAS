...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="../Imagenes/images/F.png">
    ...
    <link href="../css/css/responsive-color.css" rel="stylesheet">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" data-aos="fade-down" data-aos-delay="500">
      <div class="container">
        <a class="navbar-brand" href="index.html"><img style="width: 50%;" src="../Imagenes/images/Logo.png"></a>
                    ...
                    <div class="mosh-team-slides owl-carousel">
                        ...
                        <div class="single-team-slide text-center">
                            ...
                            <div class="single-team-slide team-thumbnail">
                                <img src="../Imagenes/images/Vinos y Licores.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                        ...
                        <div class="single-team-slide text-center">
                            ...
                            <div class="team-thumbnail">
                                <img src="../Imagenes/images/descarga.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
                                <h4>Embutidos</h4>
                        ...
                        <div class=" text-center">
                            <!-- Thumbnail -->
                            <div class="team-thumbnail">
                                <img src="../Imagenes/images/Snacks.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
                                <h4>Snacks</h4>
                        ...
                        <div class=" text-center">
                            <!-- Thumbnail -->
                            <div class="single-team-slide team-thumbnail">
                                <img src="../Imagenes/images/Panadería y Repostería.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
                        ...
                        <div class=" text-center">
                            <!-- Thumbnail -->
                            <div class="single-team-slide team-thumbnail">
                                <img src="../Imagenes/images/Aseo.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                        ...
                        <div class="single-team-slide text-center">
                            <!-- Thumbnail -->
                            <div class="team-thumbnail">
                                <img src="../Imagenes/images/Aceite y Mantequilla.jpg" alt="">
                            </div>
                            <!-- Meta Info -->
                            <div class="team-meta-info">
...
<div class="row">
  ...
  <!-- ***** CTA Area Start ***** -->
    <section class="mosh-call-to-action-area bg-img bg-overlays section_padding_100" style="background-image: url(../Imagenes/images/Foto.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-12">
 ...
 <script src="../js/js/jquery.min.js"></script>
  ...
  <script src="../js/js/bootstrap2.min.js"></script>
  ...
  <script src="../js/js/jquery.immersive-slider.js"></script>
    ...
    <!-- Popper js -->
    <script src="../js/js/Motpopper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="../js/js/Onebootstrap.min.js"></script>
    <!-- All Plugins js -->
