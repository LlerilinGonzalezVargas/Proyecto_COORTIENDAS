      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item" ><a href="contacto.php" class="nav-link"><strong> Contáctenos </strong></a></li>
            <li class="nav-item"><a href="indexclientes.php" class="nav-link"><strong> Productos </strong></a></li>
          </ul>
          <!-- Search Form Area Start -->
                               <div class="login-register-btn" >
                                    <a href="IniciarSesion.php"><font style="vertical-align: inherit; font-size: 12px;"><font style="vertical-align: inherit;"> </font></font></a><br>
                                    <a href="Registro.php"><font style="vertical-align: inherit; font-size: 12px;"><font style="vertical-align: inherit;"><img class="close" src="img/salir.png" alt="Salir" title="Salir"></font></font></a
>                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-feature-area d-flex">
                                    ...
                                    <div class="feature-content">
                                        ...
                                        <p>Sorprendete de nuestros maravillosas productos</p>
                                    </div>
                                </div>
                            </div>
                            <!-- Single Feature Area -->
