...
Public function ConsultarCliente($Id_Clie){
  $this->Conexion=Conectarse();   
  $sql="select Id_clie, Est_clie,name_est_usu, Nam_clie, email_clie, Pass_clie from est_usu,cliente where Id_clie='$Id_Clie' and (est_usu.Id_est_usu=cliente.Est_clie) and (citas.citMedico=medicos.idMedico) and (citas.citConsultorio=consultorios.idConsultorio);";
  $resultado=$this->Conexion->query($sql);
...
Public function ConsultarClientes($Id_Clie){
  $this->Conexion=Conectarse();   
  $sql="select Id_clie, Est_clie,name_est_usu, Nam_clie, email_clie, Pass_clie, from est_usu,cliente where  (est_usu.Id_est_usu=cliente.Est_clie)  and Id_clie='$Id_Clie';";
  $resultado=$this->Conexion->query($sql);
