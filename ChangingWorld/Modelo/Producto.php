...
/*------------------- Metodos de consulta-------------------- */
public function Crear_Producto($EstadoProd_Id_est_prod  ,$TipProd_Id_tip_prod  ,$Proveedor_Id_prov  ,$Name_prod  ,$Img_prod  ,$Carac_prod  ,$Puntua_prod  ,$Val_prod  ,$Iva_prod ,$Presen_prod,$Tam_prod ){
...
public function Agregar_Producto(){
  ...
  $sql="insert into producto (Est_prod,Tip_prod,Prov,Nam_prod,Img_prod,Carac_prod,Puntua_prod,Val_prod,Iva_prod,Presen_prod,Tam_prod) 
  values ('$this->EstadoProd_Id_est_prod','$this->TipProd_Id_tip_prod','$this->Proveedor_Id_prov','$this->Name_prod','$this->Img_prod','$this->Carac_prod','$this->Puntua_prod','$this->Val_prod','$this->Iva_prod','$this->Presen_prod','$this->Tam_prod');";
